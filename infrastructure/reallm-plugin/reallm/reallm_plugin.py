# Run the REaLLM server and open the REaLLM selector UI.
# @author mahaloz
# @category AI
# @menupath Tools.REaLLM.Start REaLLM Backend


python_library_command = "reallm -s ghidra"
shell_library_command = "reallm -s ghidra"
def create_plugin(*args, **kwargs):
    from reallm import create_plugin as _create_plugin
